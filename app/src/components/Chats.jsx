...
function Chats() {
    ...
    return <Container>
        <Container TagName="ul" className="sm: 1/2 gap-4 py-10 ">
            {currentChats.map(currentChat => <li className="flex flex-row justify-around w-[30ch] p-3 rounded-lg border-solid border-2 border-[#d6d3d1] drop-shadow-md" key={currentChat.id} id={currentChat.id} >
