...
function SearchNannies({ listUpdateStamp }) {
    ...
    return <Container className='sm:h-full mb-20 items-center,justify-center'>
        ...
        <Container TagName="form" className='sm: p-5' onSubmit={handleSubmit}>
            <label className="p-5 font-['Varela Round']" htmlFor="search">SEARCH NANNIES</label>
            ...
            <fieldset className='sm: flex flex-row p-5 border-solid border-2 border-[#fb923c] rounded-md mt-4 drop-shadow-md'>
                <legend>Price</legend>
        ...
        <Container className="gap-2">
            ...
            {nannies.map(nanny => <li className="w-[30ch] p-3 rounded-lg border-solid border-2 border-[#d6d3d1] list-none drop-shadow-md" key={nanny.id} id={nanny.id}>
